...
#define MIN_Z_X_POS       (4.8)
#define MIN_Z_Y_POS       (6.6)
#define XYPOS_X_POS       (34.00)
#define XYPOS_Y_POS       (3.0)
...
#endif
#define DEFAULT_MAX_FEEDRATE          {18000/60.0, 7500.0/60.0, 250.0/60.0, 140.0/60.0}    // (mm/sec)
