...
#if defined TRINAMIC_DRIVERS && TRINAMIC_DRIVERS == 2 // V-One Plus control board.
...
#if defined TRINAMIC_DRIVERS && TRINAMIC_DRIVERS == 1
#error This failed!

#define X_STEP_PIN         35
#define X_DIR_PIN          36
#define X_ENABLE_PIN       33 // Fix this - swap in schematic.
#define X_CS_PIN           34 //FIX THIS
#define X_MIN_PIN          41
#define X_MAX_PIN          41
#define X_LIM_PIN          41
