...
namespace logging {
  ...
  inline const __FlashStringHelper* openBrace() { return F("{ "); }
  inline const __FlashStringHelper* closeBrace() { return F(" }"); }

  inline const __FlashStringHelper* endString() { return F("\""); }
  inline const __FlashStringHelper* endStringComma() { return F("\", "); }

  inline const __FlashStringHelper* errorName() { return F("\"name\": \""); }
  inline const __FlashStringHelper* errorContext() { return F("\"context\": \""); }
  inline const __FlashStringHelper* errorReason() { return F("\"reason\": \""); }
}
